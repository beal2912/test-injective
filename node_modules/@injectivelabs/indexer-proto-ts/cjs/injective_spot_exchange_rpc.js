...
exports.OrderbookResponse = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.orderbook !== undefined) {
            exports.SpotLimitOrderbook.encode(message.orderbook, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.orderbook = exports.SpotLimitOrderbook.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        return { orderbook: isSet(object.orderbook) ? exports.SpotLimitOrderbook.fromJSON(object.orderbook) : undefined };
    },
    toJSON(message) {
        const obj = {};
        message.orderbook !== undefined &&
            (obj.orderbook = message.orderbook ? exports.SpotLimitOrderbook.toJSON(message.orderbook) : undefined);
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.orderbook = (object.orderbook !== undefined && object.orderbook !== null)
            ? exports.SpotLimitOrderbook.fromPartial(object.orderbook)
            : undefined;
        return message;
    },
};
function createBaseSpotLimitOrderbook() {
    return { buys: [], sells: [], timestamp: "0" };
}
exports.SpotLimitOrderbook = {
    encode(message, writer = minimal_1.default.Writer.create()) {
    ...
    create(base) {
        return exports.SpotLimitOrderbook.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseSpotLimitOrderbook();
...
exports.OrderbooksResponse = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        for (const v of message.orderbooks) {
            exports.SingleSpotLimitOrderbook.encode(v, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.orderbooks.push(exports.SingleSpotLimitOrderbook.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        return {
            orderbooks: Array.isArray(object === null || object === void 0 ? void 0 : object.orderbooks)
                ? object.orderbooks.map((e) => exports.SingleSpotLimitOrderbook.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if (message.orderbooks) {
            obj.orderbooks = message.orderbooks.map((e) => e ? exports.SingleSpotLimitOrderbook.toJSON(e) : undefined);
        }
        else {
            obj.orderbooks = [];
        }
    ...
    fromPartial(object) {
        var _a;
        const message = createBaseOrderbooksResponse();
        message.orderbooks = ((_a = object.orderbooks) === null || _a === void 0 ? void 0 : _a.map((e) => exports.SingleSpotLimitOrderbook.fromPartial(e))) || [];
        return message;
    },
};
function createBaseSingleSpotLimitOrderbook() {
    return { marketId: "", orderbook: undefined };
}
exports.SingleSpotLimitOrderbook = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.marketId !== "") {
            writer.uint32(10).string(message.marketId);
        }
        if (message.orderbook !== undefined) {
            exports.SpotLimitOrderbook.encode(message.orderbook, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        return {
            marketId: isSet(object.marketId) ? String(object.marketId) : "",
            orderbook: isSet(object.orderbook) ? exports.SpotLimitOrderbook.fromJSON(object.orderbook) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    create(base) {
        return exports.SingleSpotLimitOrderbook.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseSingleSpotLimitOrderbook();
...
class InjectiveSpotExchangeRPCClientImpl {
    ...
    Orderbook(request, metadata) {
        return this.rpc.unary(exports.InjectiveSpotExchangeRPCOrderbookDesc, exports.OrderbookRequest.fromPartial(request), metadata);
    }
    ...
    Orderbooks(request, metadata) {
        return this.rpc.unary(exports.InjectiveSpotExchangeRPCOrderbooksDesc, exports.OrderbooksRequest.fromPartial(request), metadata);
    }
    ...
    StreamOrderbook(request, metadata) {
        return this.rpc.invoke(exports.InjectiveSpotExchangeRPCStreamOrderbookDesc, exports.StreamOrderbookRequest.fromPartial(request), metadata);
    }
...
exports.InjectiveSpotExchangeRPCOrderbookDesc = {
...
exports.InjectiveSpotExchangeRPCOrderbooksDesc = {
...
exports.InjectiveSpotExchangeRPCStreamOrderbookDesc = {
