...
function createBaseOrderbookRequest() {
    return { marketId: "" };
}
exports.OrderbookRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.marketId !== "") {
            writer.uint32(10).string(message.marketId);
        }
    ...
    create(base) {
        return exports.OrderbookRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseOrderbookRequest();
...
exports.OrderbookResponse = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.orderbook !== undefined) {
            exports.DerivativeLimitOrderbook.encode(message.orderbook, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.orderbook = exports.DerivativeLimitOrderbook.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        return { orderbook: isSet(object.orderbook) ? exports.DerivativeLimitOrderbook.fromJSON(object.orderbook) : undefined };
    },
    toJSON(message) {
        const obj = {};
        message.orderbook !== undefined &&
            (obj.orderbook = message.orderbook ? exports.DerivativeLimitOrderbook.toJSON(message.orderbook) : undefined);
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.orderbook = (object.orderbook !== undefined && object.orderbook !== null)
            ? exports.DerivativeLimitOrderbook.fromPartial(object.orderbook)
            : undefined;
        return message;
    },
};
function createBaseDerivativeLimitOrderbook() {
    return { buys: [], sells: [], timestamp: "0" };
}
exports.DerivativeLimitOrderbook = {
    encode(message, writer = minimal_1.default.Writer.create()) {
    ...
    create(base) {
        return exports.DerivativeLimitOrderbook.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseDerivativeLimitOrderbook();
...
function createBaseOrderbooksRequest() {
    return { marketIds: [] };
}
exports.OrderbooksRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        for (const v of message.marketIds) {
            writer.uint32(10).string(v);
        }
    ...
    create(base) {
        return exports.OrderbooksRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseOrderbooksRequest();
...
function createBaseOrderbooksResponse() {
    return { orderbooks: [] };
}
exports.OrderbooksResponse = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        for (const v of message.orderbooks) {
            exports.SingleDerivativeLimitOrderbook.encode(v, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.orderbooks.push(exports.SingleDerivativeLimitOrderbook.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON(object) {
        return {
            orderbooks: Array.isArray(object === null || object === void 0 ? void 0 : object.orderbooks)
                ? object.orderbooks.map((e) => exports.SingleDerivativeLimitOrderbook.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if (message.orderbooks) {
            obj.orderbooks = message.orderbooks.map((e) => e ? exports.SingleDerivativeLimitOrderbook.toJSON(e) : undefined);
        }
        else {
            obj.orderbooks = [];
        }
    ...
    create(base) {
        return exports.OrderbooksResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseOrderbooksResponse();
        message.orderbooks = ((_a = object.orderbooks) === null || _a === void 0 ? void 0 : _a.map((e) => exports.SingleDerivativeLimitOrderbook.fromPartial(e))) || [];
        return message;
    },
};
function createBaseSingleDerivativeLimitOrderbook() {
    return { marketId: "", orderbook: undefined };
}
exports.SingleDerivativeLimitOrderbook = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.marketId !== "") {
            writer.uint32(10).string(message.marketId);
        }
        if (message.orderbook !== undefined) {
            exports.DerivativeLimitOrderbook.encode(message.orderbook, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        return {
            marketId: isSet(object.marketId) ? String(object.marketId) : "",
            orderbook: isSet(object.orderbook) ? exports.DerivativeLimitOrderbook.fromJSON(object.orderbook) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    create(base) {
        return exports.SingleDerivativeLimitOrderbook.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseSingleDerivativeLimitOrderbook();
...
function createBaseStreamOrderbookRequest() {
    return { marketIds: [] };
}
exports.StreamOrderbookRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        for (const v of message.marketIds) {
            writer.uint32(10).string(v);
        }
    ...
    create(base) {
        return exports.StreamOrderbookRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseStreamOrderbookRequest();
...
function createBaseStreamOrderbookResponse() {
    return { orderbook: undefined, operationType: "", timestamp: "0", marketId: "" };
}
exports.StreamOrderbookResponse = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.orderbook !== undefined) {
            exports.DerivativeLimitOrderbook.encode(message.orderbook, writer.uint32(10).fork()).ldelim();
        }
    ...
    create(base) {
        return exports.StreamOrderbookResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseStreamOrderbookResponse();
...
class InjectiveDerivativeExchangeRPCClientImpl {
    ...
    Orderbook(request, metadata) {
        return this.rpc.unary(exports.InjectiveDerivativeExchangeRPCOrderbookDesc, exports.OrderbookRequest.fromPartial(request), metadata);
    }
    ...
    Orderbooks(request, metadata) {
        return this.rpc.unary(exports.InjectiveDerivativeExchangeRPCOrderbooksDesc, exports.OrderbooksRequest.fromPartial(request), metadata);
    }
    ...
    StreamOrderbook(request, metadata) {
        return this.rpc.invoke(exports.InjectiveDerivativeExchangeRPCStreamOrderbookDesc, exports.StreamOrderbookRequest.fromPartial(request), metadata);
    }
...
exports.InjectiveDerivativeExchangeRPCOrderbookDesc = {
    ...
    requestType: {
        serializeBinary() {
            return exports.OrderbookRequest.encode(this).finish();
        },
    },
    responseType: {
        deserializeBinary(data) {
            const value = exports.OrderbookResponse.decode(data);
            return Object.assign(Object.assign({}, value), { toObject() {
                    return value;
                } });
        },
...
exports.InjectiveDerivativeExchangeRPCOrderbooksDesc = {
    ...
    requestType: {
        serializeBinary() {
            return exports.OrderbooksRequest.encode(this).finish();
        },
    },
    responseType: {
        deserializeBinary(data) {
            const value = exports.OrderbooksResponse.decode(data);
            return Object.assign(Object.assign({}, value), { toObject() {
                    return value;
                } });
        },
...
exports.InjectiveDerivativeExchangeRPCStreamOrderbookDesc = {
    ...
    requestType: {
        serializeBinary() {
            return exports.StreamOrderbookRequest.encode(this).finish();
        },
    },
    responseType: {
        deserializeBinary(data) {
            const value = exports.StreamOrderbookResponse.decode(data);
            return Object.assign(Object.assign({}, value), { toObject() {
                    return value;
                } });
        },
