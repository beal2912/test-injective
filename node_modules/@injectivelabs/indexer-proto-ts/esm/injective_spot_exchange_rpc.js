...
export const SpotLimitOrderbook = {
    ...
    create(base) {
        return SpotLimitOrderbook.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseSpotLimitOrderbook();
...
export const OrderbooksResponse = {
    ...
    fromJSON(object) {
        return {
            orderbooks: Array.isArray(object === null || object === void 0 ? void 0 : object.orderbooks)
                ? object.orderbooks.map((e) => SingleSpotLimitOrderbook.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
    ...
    fromPartial(object) {
        var _a;
        const message = createBaseOrderbooksResponse();
        message.orderbooks = ((_a = object.orderbooks) === null || _a === void 0 ? void 0 : _a.map((e) => SingleSpotLimitOrderbook.fromPartial(e))) || [];
        return message;
    },
};
...
export const SingleSpotLimitOrderbook = {
    ...
    create(base) {
        return SingleSpotLimitOrderbook.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseSingleSpotLimitOrderbook();
...
export class InjectiveSpotExchangeRPCClientImpl {
    ...
    StreamOrderbook(request, metadata) {
        return this.rpc.invoke(InjectiveSpotExchangeRPCStreamOrderbookDesc, StreamOrderbookRequest.fromPartial(request), metadata);
    }
...
export const InjectiveSpotExchangeRPCOrderbookDesc = {
...
export const InjectiveSpotExchangeRPCOrderbooksDesc = {
...
export const InjectiveSpotExchangeRPCStreamOrderbookDesc = {
