...
export const OrderbookRequest = {
    ...
    create(base) {
        return OrderbookRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseOrderbookRequest();
...
export const OrderbookResponse = {
    ...
    create(base) {
        return OrderbookResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseOrderbookResponse();
...
export const DerivativeLimitOrderbook = {
    ...
    create(base) {
        return DerivativeLimitOrderbook.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseDerivativeLimitOrderbook();
...
export const OrderbooksRequest = {
    ...
    create(base) {
        return OrderbooksRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseOrderbooksRequest();
...
export const OrderbooksResponse = {
    ...
    fromJSON(object) {
        return {
            orderbooks: Array.isArray(object === null || object === void 0 ? void 0 : object.orderbooks)
                ? object.orderbooks.map((e) => SingleDerivativeLimitOrderbook.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
    ...
    create(base) {
        return OrderbooksResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseOrderbooksResponse();
        message.orderbooks = ((_a = object.orderbooks) === null || _a === void 0 ? void 0 : _a.map((e) => SingleDerivativeLimitOrderbook.fromPartial(e))) || [];
        return message;
    },
};
...
export const SingleDerivativeLimitOrderbook = {
    ...
    create(base) {
        return SingleDerivativeLimitOrderbook.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseSingleDerivativeLimitOrderbook();
...
export const StreamOrderbookRequest = {
    ...
    create(base) {
        return StreamOrderbookRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseStreamOrderbookRequest();
...
export const StreamOrderbookResponse = {
    ...
    create(base) {
        return StreamOrderbookResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseStreamOrderbookResponse();
...
export class InjectiveDerivativeExchangeRPCClientImpl {
    ...
    Orderbooks(request, metadata) {
        return this.rpc.unary(InjectiveDerivativeExchangeRPCOrderbooksDesc, OrderbooksRequest.fromPartial(request), metadata);
    }
    ...
    StreamOrderbook(request, metadata) {
        return this.rpc.invoke(InjectiveDerivativeExchangeRPCStreamOrderbookDesc, StreamOrderbookRequest.fromPartial(request), metadata);
    }
...
export const InjectiveDerivativeExchangeRPCOrderbookDesc = {
...
export const InjectiveDerivativeExchangeRPCOrderbooksDesc = {
...
export const InjectiveDerivativeExchangeRPCStreamOrderbookDesc = {
