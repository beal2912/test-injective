...
export declare enum PythStatus {
...
export declare function pythStatusFromJSON(object: any): PythStatus;
export declare function pythStatusToJSON(object: PythStatus): string;
