...
(function (PythStatus) {
    ...
    PythStatus[PythStatus["Unknown"] = 0] = "Unknown";
    /** Trading - The price feed is updating as expected. */
    PythStatus[PythStatus["Trading"] = 1] = "Trading";
    /** Halted - The price feed is not currently updating because trading in the product has been halted. */
    PythStatus[PythStatus["Halted"] = 2] = "Halted";
    /** Auction - The price feed is not currently updating because an auction is setting the price. */
    PythStatus[PythStatus["Auction"] = 3] = "Auction";
    PythStatus[PythStatus["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(PythStatus = exports.PythStatus || (exports.PythStatus = {}));
function pythStatusFromJSON(object) {
    switch (object) {
        case 0:
        case "Unknown":
...
exports.pythStatusFromJSON = pythStatusFromJSON;
function pythStatusToJSON(object) {
    switch (object) {
...
exports.pythStatusToJSON = pythStatusToJSON;
...
exports.PriceAttestation = {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 10:
                    ...
                    break;
                case 11:
                    message.attestationTime = longToString(reader.int64());
                    break;
                case 12:
    ...
    fromPartial(object) {
        ...
        message.priceId = (_b = object.priceId) !== null && _b !== void 0 ? _b : new Uint8Array();
        message.price = (_c = object.price) !== null && _c !== void 0 ? _c : "0";
        message.conf = (_d = object.conf) !== null && _d !== void 0 ? _d : "0";
        message.expo = (_e = object.expo) !== null && _e !== void 0 ? _e : 0;
        message.emaPrice = (_f = object.emaPrice) !== null && _f !== void 0 ? _f : "0";
        message.emaConf = (_g = object.emaConf) !== null && _g !== void 0 ? _g : "0";
        message.status = (_h = object.status) !== null && _h !== void 0 ? _h : 0;
        message.numPublishers = (_j = object.numPublishers) !== null && _j !== void 0 ? _j : 0;
        message.maxNumPublishers = (_k = object.maxNumPublishers) !== null && _k !== void 0 ? _k : 0;
        message.attestationTime = (_l = object.attestationTime) !== null && _l !== void 0 ? _l : "0";
        message.publishTime = (_m = object.publishTime) !== null && _m !== void 0 ? _m : "0";
        return message;
    },
};
