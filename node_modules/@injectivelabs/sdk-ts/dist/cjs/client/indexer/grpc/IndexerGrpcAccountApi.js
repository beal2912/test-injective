...
class IndexerGrpcAccountApi {
    ...
    fetchPortfolio(address) {
        return __awaiter(this, void 0, void 0, function* () {
            const request = indexer_proto_ts_1.InjectiveAccountRpc.PortfolioRequest.create();
    ...
    fetchRewards({ address, epoch }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.Rewards(request);
    ...
    fetchSubaccountsList(address) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            request.accountAddress = address;
            try {
                const response = yield this.client.SubaccountsList(request);
    ...
    fetchSubaccountBalance(subaccountId, denom) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            request.denom = denom;
            try {
                const response = yield this.client.SubaccountBalanceEndpoint(request);
    ...
    fetchSubaccountBalancesList(subaccountId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            request.subaccountId = subaccountId;
            try {
                const response = yield this.client.SubaccountBalancesList(request);
    ...
    fetchSubaccountHistory({ subaccountId, denom, transferTypes = [], pagination, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.SubaccountHistory(request);
    ...
    fetchSubaccountOrderSummary({ subaccountId, marketId, orderDirection, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.SubaccountOrderSummary(request);
                return response;
            }
            catch (e) {
                if (e instanceof indexer_proto_ts_1.InjectiveAccountRpc.GrpcWebError) {
    ...
    fetchOrderStates(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.OrderStates(request);
                return response;
            }
            catch (e) {
                if (e instanceof indexer_proto_ts_1.InjectiveAccountRpc.GrpcWebError) {
