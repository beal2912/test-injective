...
class IndexerGrpcSpotApi {
    ...
    fetchOrderbook(marketId) {
        return __awaiter(this, void 0, void 0, function* () {
            const request = indexer_proto_ts_1.InjectiveSpotExchangeRpc.OrderbookRequest.create();
            request.marketId = marketId;
            try {
    ...
    fetchOrderbooks(marketIds) {
        return __awaiter(this, void 0, void 0, function* () {
            const request = indexer_proto_ts_1.InjectiveSpotExchangeRpc.OrderbooksRequest.create();
