...
class IndexerGrpcDerivativesApi {
    ...
    fetchOrderbook(marketId) {
        return __awaiter(this, void 0, void 0, function* () {
            const request = indexer_proto_ts_1.InjectiveDerivativeExchangeRpc.OrderbookRequest.create();
            request.marketId = marketId;
            try {
                const response = yield this.client.Orderbook(request);
    ...
    fetchOrderbooks(marketIds) {
        return __awaiter(this, void 0, void 0, function* () {
            const request = indexer_proto_ts_1.InjectiveDerivativeExchangeRpc.OrderbooksRequest.create();
            if (marketIds.length > 0) {
                request.marketIds = marketIds;
            }
            try {
                const response = yield this.client.Orderbooks(request);
