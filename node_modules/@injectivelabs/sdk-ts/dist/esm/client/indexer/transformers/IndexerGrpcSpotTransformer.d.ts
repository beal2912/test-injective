...
export declare class IndexerGrpcSpotTransformer {
    ...
    static orderbookResponseToOrderbook(response: InjectiveSpotExchangeRpc.OrderbookResponse): Orderbook;
    static orderbooksResponseToOrderbooks(response: InjectiveSpotExchangeRpc.OrderbooksResponse): {
        marketId: string;
        orderbook: Orderbook;
    }[];
