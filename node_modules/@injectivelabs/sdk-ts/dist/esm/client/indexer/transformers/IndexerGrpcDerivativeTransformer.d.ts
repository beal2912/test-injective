...
export declare class IndexerGrpcDerivativeTransformer {
    ...
    static orderbookResponseToOrderbook(response: InjectiveDerivativeExchangeRpc.OrderbookResponse): Orderbook;
    ...
    static orderbooksResponseToOrderbooks(response: InjectiveDerivativeExchangeRpc.OrderbooksResponse): {
        marketId: string;
        orderbook: Orderbook;
    }[];
