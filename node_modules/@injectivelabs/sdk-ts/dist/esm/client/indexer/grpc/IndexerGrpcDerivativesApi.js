...
export class IndexerGrpcDerivativesApi {
    ...
    async fetchOrderbook(marketId) {
        ...
        try {
            ...
            return IndexerGrpcDerivativeTransformer.orderbookResponseToOrderbook(response);
        }
        catch (e) {
            if (e instanceof InjectiveDerivativeExchangeRpc.GrpcWebError) {
                throw new GrpcUnaryRequestException(new Error(e.toString()), {
    ...
    async fetchOrderbooks(marketIds) {
        ...
        try {
            ...
            return IndexerGrpcDerivativeTransformer.orderbooksResponseToOrderbooks(response);
        }
        catch (e) {
            if (e instanceof InjectiveDerivativeExchangeRpc.GrpcWebError) {
                throw new GrpcUnaryRequestException(new Error(e.toString()), {
