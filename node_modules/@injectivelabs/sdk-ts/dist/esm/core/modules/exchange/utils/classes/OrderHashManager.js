    ...
    return {
        ...
        message: {
            ...
            OrderInfo: {
                ...
                Quantity: cosmosSdkDecToBigNumber(spotOrder.orderInfo.quantity).toFixed(),
            },
            Salt: nonce.toString(),
    ...
    return {
        ...
        message: {
            ...
            OrderInfo: {
                ...
                Price: cosmosSdkDecToBigNumber(derivativeOrder.orderInfo.price).toFixed(),
                Quantity: cosmosSdkDecToBigNumber(derivativeOrder.orderInfo.quantity).toFixed(),
            },
